...
@Path("bbs/uploadImg")
//@Resource(code=30001)
public class UploadImgResource extends BaseUpLoadResource {
    ...
    public Response uploadFile(){
    	return super.doConsume("Img");
    	
    }
    
    @GET
    @Path(value = "/getimg/{date}/{batchNo}")
    public String getImg( @PathParam("date") String date,
        @PathParam("batchNo") String batchNo)
        throws BusinessAccessException {
      InputStream iStream = null;
      ServletOutputStream outputStream = null;
      try {
       	String rootPath = "D:/picture";
