...
const Detail = ({ activityDetail, dispatch }) => {
  const { data, userName, organization } = activityDetail
  return (
...
export default connect(({ activityDetail, loading }) => ({ activityDetail, loading }))(Detail)
