  ...
  render() {
    return (
      <div className={styles.writearticle}>
        ...
        {/* 将生成编辑器 */}
        <div className={styles.textarea} ref="editorElem" style={{ height:'55px', background:'white', border: "1px solid #aaa",zIndex:'10001'}}>
        </div>

        <div ref="editor1" style={{  border: "1px solid #aaa",background:'white',  height:"500px",zIndex:'100'}}>
          </div>
